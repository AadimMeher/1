...
x            #here, we are first assigning the value/seq, and then printing(takes 2 steps)
(x1 <- 1:20)  # brackets - assign & print(takes 1 step)
...
(x5=c(3L,5L, 100L)) #suffix by L to get integer values
class(x5)
x5a = c(3,5)
class(x5a)
(x5b = c(1, 'a',T, 4L))
